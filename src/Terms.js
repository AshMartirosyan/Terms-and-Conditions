...
export default function TermsComponent({ id }) {
  return (
    <TermsText id={id}>
      <Title>
        Terms of Service <br />
      ...
      <Text>
        This website is operated by Expetitle LLC. Throughout the site, the
        terms “we”, “us” and “our” refer to Expetitle LLC. Expetitle LLC offers
      ...
      <Text>
        Your submission of personal information through us is governed by our
        Privacy Policy, which is accessible via our website.
        <br />
      </Text>
      <Text>
      ...
      <Text>
        ...
        to product descriptions, pricing, promotions, offers, etc. We reserve
        the right to correct any errors, inaccuracies or omissions, and to
        change or update information in the Service or on any related website is
      ...
      <Text>
        In no case shall Expetitle LLC, our directors, officers, employees,
      ...
      <Text>
        You agree to indemnify, defend and hold harmless Expetitle LLC and our
      ...
      <Text>
        ...
        laws of 400 NW 26th St, Miami, FL, 33127, United States.
        <br />
      </Text>
      <Text>
